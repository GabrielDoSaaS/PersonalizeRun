...
const AdmPainel = () => {
  ...
  // A LÓGICA DE FILTRO FOI ALTERADA AQUI PARA SER MAIS ROBUSTA
  // Agora, filtra explicitamente usando o operador `!!` para converter o valor para booleano
  useEffect(() => {
    // Compraram na oferta: `afterOffer` é um valor "falso" (undefined, null, false, 0, "")
    const onOffer = payers.filter(payer => !payer.afterOffer);
    // Compraram após a oferta: `afterOffer` é um valor "verdadeiro" (true, "true", 1, etc.)
